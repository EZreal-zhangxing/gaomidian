...
public class BannerController {
	...
	public List<Banner> getAllbanner(@RequestParam(value = "belong")  Integer belong)
	{
		return bannerService.getAllbanner(belong);
	}
	...
	public void uploadBanner(HttpServletResponse response,HttpServletRequest request,@RequestParam(value = "filepath")  MultipartFile file) throws IOException
	{
...
//		BufferedWriter bw=new BufferedWriter(new OutputStreamWriter(response.getOutputStream()));
		...
		String bel=request.getParameter("optionsRadios");
		banner.setBelong(Integer.parseInt(bel));
...
//				return new Message("fail", "保存失败", new Date());
			...
			reslue=bannerService.saveBanner(banner);
		}	
